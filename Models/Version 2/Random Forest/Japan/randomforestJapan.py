...
# load the dataset
globalactive = pd.read_csv('JapanActive.csv')
globalactive = globalactive.drop(labels='Date', axis=1)

series = pd.read_csv('JapanActive copy.csv', header=0, index_col=0)
...
series2 = pd.read_csv('JapanActive.csv', header=0, index_col=0)
