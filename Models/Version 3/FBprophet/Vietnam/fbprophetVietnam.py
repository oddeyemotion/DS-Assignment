...
series = pd.read_csv(
    'https://raw.githubusercontent.com/ll-cooool-j/DS-Assignment/main/Datasets/Datasets%20for%20daily%20data%20plots/Vietnam%20(Date%20%2B%20New%20Cases%20%2B%20Smoothed%20New%20Cases).csv', header=0, parse_dates=[0], squeeze=True, date_parser=parser)

evaluate = pd.read_csv('https://raw.githubusercontent.com/ll-cooool-j/DS-Assignment/main/Datasets/Datasets%20for%20RFR%20(Only%20Date%20%2B%20New%20cases)/Vietnam%20-%2014%20days%20of%20June%20(Only%20Date%20%2B%20New%20cases).csv',
...
pp.add_country_holidays(country_name='VN')
