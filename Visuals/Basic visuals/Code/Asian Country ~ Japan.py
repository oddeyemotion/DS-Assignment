...
japan_dis.suptitle('Japan histograms', fontsize=16)

subA = japan_dis.add_subplot(131)
plt.hist(japan1['Confirmed'], bins=50)
plt.gca().set(title='Confirmed Frequency Histogram', xlabel = 'Number of people', ylabel='Frequency');

subB = japan_dis.add_subplot(132)
plt.hist(japan1['Deaths'], bins=50)
plt.gca().set(title='Deaths Frequency Histogram', xlabel = 'Number of people', ylabel='Frequency');

subC = japan_dis.add_subplot(133)
plt.hist(japan1['Recovered'], bins=50)
