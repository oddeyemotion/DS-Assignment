...
vietnam_dis = plt.figure()
vietnam_dis.suptitle('Vietnam histograms', fontsize=16)

subA = vietnam_dis.add_subplot(131)
plt.hist(vietnam1['Confirmed'], bins=50)
plt.gca().set(title='Confirmed Frequency Histogram', xlabel = 'Number of people', ylabel='Frequency');

subB = vietnam_dis.add_subplot(132)
plt.hist(vietnam1['Deaths'], bins=50)
plt.gca().set(title='Deaths Frequency Histogram', xlabel = 'Number of people', ylabel='Frequency');

subC = vietnam_dis.add_subplot(133)
plt.hist(vietnam1['Recovered'], bins=50)
